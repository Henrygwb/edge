...
if args.explainer == 'value':
    ...
    np.savez_compressed(save_path + 'value_exp.npz', sal=sal_value)
      ...
      model_1 = 'dgp_regression_GRU_600_False_False_False_False_False_False_True_0.01_10_16_True_3_model.data'
      dgp_explainer = DGPXRL(train_len=30123, seq_len=seq_len, len_diff=len_diff, input_dim=input_dim,
                             ...
                             n_epoch=2, gamma=0.1, num_inducing_points=600, n_action=n_action, embed_dim=embed_dim,
      ...
      dgp_1_fid_results = np.load(
            save_path + 'dgp_regression_GRU_600_False_False_False_False_False_False_True_0.01_10_16_True_3_exp.npz')
